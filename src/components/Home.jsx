...
function Home() {
  ...
  return (
    <div className="bg-[url('assets/arseny-togulev-DE6rYp1nAho-unsplash.jpg')] bg-cover w-full p-1 pt-48">
      <h1 className="text-3xl font-bold underline">
        Welcome To Anesthesiologists Specilist
      </h1>

      <h3 className="text-center text-body-emphasis">
      ...
      <h5>
        Patients typically see an anesthesiologist if they are planning to have
        a medical procedure or surgery that requires anesthesia.
        Anesthesiologists are medical doctors who specialize in administering
        anesthesia and providing care before, during, and after surgery. They
        also help ensure patient safety and manage pain during and after
        surgery.
      </h5>
      <br />

      <h5>
        Anesthesiologists may also specialize in pain management for patients
        with conditions that cause pain. They have 12–14 years of education,
        including medical school, and 12,000–16,000 hours of clinical training.
        Anesthesiologists also maintain records of a patients vital functions,
