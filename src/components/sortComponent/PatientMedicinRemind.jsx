      ...
      <div>
        ...
        <div className="pb-3">
          ...
          <p className="text-xl m-1">
            ...
            <li className="text-xl m-1">Pain Reliever: [Medication Name], [Dosage], [Frequency]</li>
            <li className="text-xl pb-3">Antibiotic: [Medication Name], [Dosage], [Frequency]</li>
          </p>
        </div>
        <div className="pb-2">
          <p className="font-bold text-2xl pb-2">Instructions:</p>
          <p>
            <li className="text-xl m-1">Take the pain reliever with food to avoid an upset stomach.</li>
