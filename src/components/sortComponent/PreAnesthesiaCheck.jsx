      ...
      <div>
        ...
        <form className="font-bold text-center" action="">
          ...
          <div className="form-control items-center">
            <label className="label cursor-pointer">
              <span className="label-text mr-2">
                Current medications include herbal supplements or
          ...
          <div className="form-control items-center">
            <label className="label cursor-pointer">
              <span className="label-text mr-2">
                History of chronic diseases e.g., asthma, diabetes,
          ...
          <div className="form-control items-center">
            <label className="label cursor-pointer">
              <span className="label-text mr-2">
                Airway assessment (e.g., Mallampati score to predict difficulty
                in intubation)
              </span>
              <input type="checkbox" defaultChecked className="checkbox" />
            </label>
          ...
          <div className="form-control items-center">
            <label className="label cursor-pointer">
              <span className="label-text mr-2">
                Confirm the availability of the surgical team and
                anesthesiologist
              </span>
              <input type="checkbox" defaultChecked className="checkbox" />
            </label>
